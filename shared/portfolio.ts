export const portfolioServices: Record<string, Record<string, string>> = {
  ...
  trades: {'metal-fabrication':'Metal fabrication','concrete-work':'Concrete work','industrial-insulation':'Industrial insulation','multi-trade-projects':'Multiple trades','carport-and-slab':'Carport and slab','driveway-and-gate':'Driveway and gate','commercial-property-maintenance':'Commercial property maintenance'},
};
