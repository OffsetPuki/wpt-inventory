...
export const DEFAULT_JOB_TEMPLATES: JobTemplateSeed[] = [
  ...
  {
    key: "controls_retrofit",
    label: "Controls / software retrofit",
    blurb: "Upgrade or replace the PCS control system — PLC, I/O, HMI, wiring, and terminal blocks.",
    icon: "cpu",
    params: [
      { key: "channels", label: "I/O channels", kind: "number", defaultValue: 32 },
      {
        key: "hasHmi",
        label: "New HMI?",
        kind: "select",
    ...
    parts: [
      ...
      {
        label: "I/O modules (16-ch)",
        equipmentType: "pcs_control",
        category: "it",
        qty: "ceil(channels / 16)",
        unit: "ea",
      },
      {
        label: "HMI touchscreen",
        equipmentType: "pcs_control",
        category: "it",
        qty: 1,
        unit: "ea",
        notes: "Only if hasHmi = Yes",
      },
      {
  ...
  {
    key: "burner_retrofit",
    label: "Burner retrofit (low-NOx)",
    blurb: "Retrofit an existing oven or autoclave heating system to a low-NOx burner configuration.",
    icon: "thermometer",
    params: [
      {
        key: "btuRating",
      ...
      },
      {
        ...
        label: "Fuel type",
        kind: "select",
        options: ["NG", "Propane", "Dual"],
        defaultValue: "NG",
      },
    ],
    parts: [
      {
        label: "Low-NOx burner assembly",
        equipmentType: "burner_heating",
        category: "electric",
        qty: 1,
        unit: "ea",
      ...
      {
        label: "Gas train (valve assembly)",
        equipmentType: "burner_heating",
        category: "electric",
        qty: 1,
        unit: "set",
      ...
      {
        label: "Flame safeguard controller",
        equipmentType: "burner_heating",
        category: "electric",
        qty: 1,
        unit: "ea",
